...
var xeonytimewisher = `Good Evening 🌃`
 ...
 if(time2 < "15:00:00"){
var xeonytimewisher = `Good Afternoon 🏙️`
 }
 if(time2 < "11:00:00"){
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By Limule Solitarus-sama Bot Owner ${ownername} For more  Hacks Search On Youtube Deaethgun635`).catch(_ => _)
        }
        ...
        switch (command) {
            ...
            case 'clearsession': {
                ...
                fs.readdir("./session", async function(err, files) {
                    ...
                    await sleep(2000)
                    replygcxeon("Remark: Successfully deleted all the trash in the session folder")
                });
            }
            break
            case 'join':
            ...
            case 'getsession':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon('Master,Wait a moment, currently retrieving your session file')
            ...
            case 'autoread':
                ...
                if (q === 'on') {
                    autoread = true
                    replygcxeon(`Remark: Successfully changed autoread to ${q}`)
                } else if (q === 'off') {
                    autoread = false
                    replygcxeon(`Remark: Successfully changed autoread to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoTyping = true
                    replygcxeon(`Remark: Successfully changed auto-typing to ${q}`)
                } else if (q === 'off') {
                    autoTyping = false
                    replygcxeon(`Remark: Successfully changed auto-typing to ${q}`)
                }
                ...
                if (q === 'on') {
                    autoRecording = true
                    replygcxeon(`Remark: Successfully changed auto-recording to ${q}`)
                } else if (q === 'off') {
                    autoRecording = false
                    replygcxeon(`Remark: Successfully changed auto-recording to ${q}`)
                }
                ...
                if (q === 'on') {
                    autorecordtype = true
                    replygcxeon(`Remark: Successfully changed auto recording and typing to ${q}`)
                } else if (q === 'off') {
    ...
    case 'autostatusview':{
            ...
            case 'autobio':
                ...
                if (q == 'on') {
                    ...
                    autobio = false
                    replygcxeon(`Remark: Successfully Changed AutoBio To ${q}`)
                }
                break
            case 'mode':
                if (!isCreator) return replygcxeon(mess.owner)
            ...
            case 'totag':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (!isAdmins) return replygcxeon(mess.admin)
                if (!m.quoted) return replygcxeon(`Master, Reply messages with captions ${prefix + command}`)
                XeonBotInc.sendMessage(m.chat, {
            ...
            case 'resetlink':
                ...
                await XeonBotInc.groupRevokeInvite(m.chat)
                    .then(res => {
                        replygcxeon(`Remark: Successful Reset, Group Invite Link ${groupMetadata.subject}`)
...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `YouTube DEATH RAPHAEL-BUG`,
            ...
            case 'runtime':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `Yt Deaethgun635`,
                            body: `Love from Limule Solitarus-sama 🤍`,
                            thumbnailUrl: 'https://telegra.ph/file/39394d8ffdd7632cb1e5c.jpg/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `Repo: https://github.com/Limule3650/Death-Raphael-bug`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF DEATH RAPHAEL-BUG is on YouTube Deaethgun635 ❤️`,
                            body: `Love You Master 🤍`,
                            thumbnailUrl: 'https://telegra.ph/file/39394d8ffdd7632cb1e5c.jpg/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
break
            ...
            case 'delvn': {
                ...
                replygcxeon(`Remark: Successfully Deleted Audio ${q}`)
            }
            break
case 'addzip':{
if (!isPremium) return replygcxeon(mess.prem)
